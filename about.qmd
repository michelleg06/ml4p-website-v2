...
<div class="grid-container">
  <div class="profile">
    <div class="main-container">
      ...
      <div class="text">
        ...
        <p>
          <a href="https://www.linkedin.com/in/stephan-dietrich-data/?originalSubdomain=nl" target="_blank">LinkedIn</a>
        </p>
  ...
  <div class="profile">
    <div class="main-container">
      <div class="image-container">
        <img src="assets/michelle.png" alt="Dr. Michelle González Amador">
      </div>
      <div class="text">
        <h3>Dr. Michelle González Amador</h3>
        <p class="subtitle">Economics, Postdoctoral researcher, Wageningen University & Research</p>
        <p>
          <a href="https://www.m-gonzalezamador.com/" target="_blank">Personal Website</a> | <a
            href="mailto:michelle.gonzalezamador@wur.nl" target="_blank">michelle.gonzalezamador@wur.nl</a> | <a
            href="https://github.com/michelleg06" target="_blank">GitHub</a> | <a
            href="https://www.linkedin.com/in/michelle-gonzalez-amador06/?originalSubdomain=nl"
            target="_blank">LinkedIn</a>
          | <a href="https://bsky.app/profile/michelleg06.bsky.social" target="_blank">BlueSky</a>
        </p>
        <a class="expand" href="#" onclick="toggleDescription(this); return false;">+ info</a>
      </div>
    </div>
  ...
  <div class="profile">
    <div class="main-container">
      ...
      <div class="text">
        ...
        <p>
          <a href="https://www.linkedin.com/in/fraroma/" target="_blank">LinkedIn</a>
        </p>
        <a class="expand" href="#" onclick="toggleDescription(this); return false;">+ info</a>
      </div>
    </div>
  ...
  <div class="profile">
    <div class="main-container">
      ...
      <div class="text">
        ...
        <p>
          <a href="https://www.linkedin.com/in/jubaziani/" target="_blank">LinkedIn</a>
        </p>
        <a class="expand" href="#" onclick="toggleDescription(this); return false;">+ info</a>
      </div>
    </div>
  ...
  <div class="profile">
    <div class="main-container">
      ...
      <div class="text">
        ...
        <p>
          <a href="https://www.linkedin.com/in/lucas-boh-405770169/" target="_blank">LinkedIn</a>
        </p>
        <a class="expand" href="#" onclick="toggleDescription(this); return false;">+ info</a>
      </div>
    </div>
