...
R is a statistical programming language. As such, it understands and categorises its input as **data types** and **data structures**.

::: {.callout-note icon="false"}
R is not too strict about data types, but you need to be able to identify them to use them in math operations.
:::
...
```{r, eval=FALSE}
setwd("/Users/yourname/somefolder")
```
:::
