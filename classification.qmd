...
We will continue to work with the Malawi dataset, which can be downloaded in the [Prediction Policy Problems](session_1.qmd) tab of this website.
...
As before, you can use the Bolivia dataset to try your hand at a logistic model. The data can be downloaded in the "Practice at home" section in the [Prediction Policy Problems](session_1.qmd) page of this site. <br>
