...
::: {.column width="50%"}
![](assets/robot-pictures/RandomForestRobot.png){fig-align="center" width="380"}
:::
::::::
...
::: callout-tip
Some discussion points before the practical example:
...
```{python, eval=FALSE}
# Uploading data
malawi = pd.read_csv('/Users/yourname/somefolder/data/malawi.csv')
```
```{python, echo=FALSE}
# Uploading data
...
```
```{python, eval=FALSE}
# this will save the tree visualisation directly into your working folder
graph.render('/Users/yourname/somefolder/assets/tree_visualisation', format='png') 
```
```{python, echo=FALSE, results='hide'}
# this will save the tree visualisation directly into your working folder
graph.render('/Users/lucas/Documents/UNU-CDO/courses/ml4p/ml4p-website-v2/assets/tree_visualisation', format='png') 
```
