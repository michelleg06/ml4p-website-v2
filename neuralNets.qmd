...
::: {.column width="50%"}
![](assets/robot-pictures/NeuralNetRobot2.png){fig-align="center" width="380"}
:::
::::::
...
setwd("/Users/yourname/somefolder") # set your working directory
```
```{r, message=FALSE}
...
```{python, eval=FALSE}
# Uploading data
malawi = pd.read_csv('/Users/yourname/somefolder/data/SHARE_subset.csv')
```
```{python, echo=FALSE}
# Uploading data
